...
export const VIRTUAL_HUMAN_TEMPLATES = [
  {
    ...
    thumbnailUrl: require('@assets/images/templates/girl_1.png'),
    personality: {
      extroversion: 0.8,
      rationality: 0.4,
      seriousness: 0.2,
  ...
  },
  {
    ...
    thumbnailUrl: require('@assets/images/templates/business_1.png'),
    personality: {
      extroversion: 0.5,
      rationality: 0.8,
      seriousness: 0.7,
  ...
  },
  {
    ...
    thumbnailUrl: require('@assets/images/templates/gentle_1.png'),
    personality: {
      extroversion: 0.4,
      rationality: 0.6,
      seriousness: 0.4,
...
export const BUILTIN_MODELS = [
  {
    ...
    gender: 'female' as const,
    style: 'anime',
    thumbnailUrl: require('@assets/images/models/female_1_thumb.png'),
  ...
  },
  {
    ...
    gender: 'female' as const,
    style: 'realistic',
    thumbnailUrl: require('@assets/images/models/female_2_thumb.png'),
  ...
  },
  {
    ...
    gender: 'male' as const,
    style: 'realistic',
    thumbnailUrl: require('@assets/images/models/male_1_thumb.png'),
...
export const BUILTIN_OUTFITS = [
  {
    ...
    category: 'casual' as const,
    season: 'all' as const,
    thumbnailUrl: require('@assets/images/outfits/casual_1.png'),
  ...
  },
  {
    ...
    category: 'business' as const,
    season: 'all' as const,
    thumbnailUrl: require('@assets/images/outfits/business_1.png'),
  ...
  },
  {
    ...
    season: 'all' as const,
    thumbnailUrl: require('@assets/images/outfits/student_1.png'),
